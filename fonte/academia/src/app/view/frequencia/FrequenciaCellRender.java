 ...
 * @author WISE
 */
public class FrequenciaCellRender extends DefaultTableCellRenderer {

    ImageIcon icon;

    FrequenciaCellRender(TableCellRenderer defaultRenderer) {
        ...
        if (value != null) {
            ...
            switch (texto) {
                ...
                case "P":
                    ...
                    label.setText("");
                    label.setToolTipText("Prensente");
                    label.setIcon(icon);
                    label.setVerticalAlignment(SwingConstants.CENTER);
                ...
                case "N":
                    ...
                    icon = new ImageIcon(getClass().getResource("/images/erro-small.png"));
