...
public class ContasReceberTableModel extends AbstractTableModel {
    ...
    private String[] colunas = new String[]{"ID", "Nome", "Data Emissão", "Vencimento", "Data. Pagamento", "Valor", "Situaçao"};

    private static final int ID = 0;
    private static final int NOME = 1;
    private static final int DATAE = 2;
    private static final int DATAV = 3;
    private static final int DATAP = 4;
    ...
    public void addRow(int idConta, String nome, String dataE, String dataV, String dataP, Float valor, String situacao, int row) {
        c = new Conta();
        c.setId(idConta);
        c.setNome(nome);
    ...
    public void updateRow(int idConta, String nome, String dataE, String dataV, String dataP, Float valor, String situacao, int row) {
        c = new Conta();
        c.setId(idConta);
        c.setNome(nome);
        c.setLancamento(dataE);
