...
public class ContasAtletasView extends javax.swing.JDialog {
    ...
    private void quitarBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_quitarBtActionPerformed
        ...
        if (situacaoMov.equals("Pago")) {
            ...
            if (ac.retornaSituacaoAtleta(Integer.parseInt(matriculaTxt.getText())).equals("N")) {
                ...
                if (dialogResultado2 == JOptionPane.YES_OPTION) {
                    if (ac.ativarAtleta(Integer.parseInt(matriculaTxt.getText())) == true) {
            ...
            if (cc.quitarConta(idMov) == true) {
                ...
                if (dialogResultado == JOptionPane.YES_OPTION) { /*Se sim*/
                    ...
                    if (cc.lancamentoRapido(dataV, valor, null, matriculaTxt.getText()) == true) {
